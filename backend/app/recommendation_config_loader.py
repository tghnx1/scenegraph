...
PROMOTER_RECOMMENDATION_SCHEMA: Mapping[str, FieldRule] = {
    ...
    "PROMOTER_REC_DIRECT_CONNECTION_WEIGHT": NON_NEGATIVE_FLOAT,
    ...
    "PROMOTER_REC_DIRECT_CONNECTION_CAP": POSITIVE_INT,
    ...
    "PROMOTER_REC_EVENT_SIMILARITY_SHARED_THEME_BONUS": NON_NEGATIVE_FLOAT,
    "PROMOTER_REC_EVENT_SIMILARITY_SHARED_MOOD_BONUS": NON_NEGATIVE_FLOAT,
    "PROMOTER_REC_ACTIVITY_EVENT_CAP": POSITIVE_INT,
    "PROMOTER_REC_EXISTING_PARTNER_DIRECT_MIN": POSITIVE_INT,
    "PROMOTER_REC_WARM_RELEVANT_CONNECTION_MIN": POSITIVE_INT,
    "PROMOTER_REC_DIRECT_EDGE_STRENGTH_MIN": ZERO_TO_ONE_FLOAT,
    "PROMOTER_REC_DIRECT_EDGE_STRENGTH_MAX": ZERO_TO_ONE_FLOAT,
...
EDGE_STRENGTH_PAIRS: tuple[tuple[str, str], ...] = (
    ("PROMOTER_REC_DIRECT_EDGE_STRENGTH_MIN", "PROMOTER_REC_DIRECT_EDGE_STRENGTH_MAX"),
